...
Самошкин Никита Сергеевич
[Telegram: https://t.me/holerochka_love]

## Описание реализации

1. Из файла 'interest.txt' программа считывает header и саму матрицу, а из файла 'influence.txt' программа считывает только матрицу 
2. Далее фунция importantStakeholdersIdxs() суммирует все каждый подмассив и если эта сумма больше, чем количество Stakeholder`ов пополам, то в список добавляется 1, иначе 0
3. Функция importantStakeholders() проверяет, если эменеты с одинаковыми индексами равны 1, то добавляет их индекс в результирующий массив
4. Функция writeToFile записывает ответ в файл result.txt

## Инструкция по сборке и запуску решения

1. Клонировать репозиторий 
2. Запустить __main__.py командой python -u "<Путь до файла>\__main__.py" или в любой удобной для вас ide. Необходимо чтобы присутствовали файлы interest.txt и influence.txt 
3. Ответ будет предоставлен в файле result.txt